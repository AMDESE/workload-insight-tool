...
class Analyzer:
    ...
    def main(self, params=None, *args):
        ...
        self.tool_details_print[f"{global_vars.sample_period}(s)"] = self.data.df[
            global_vars.sample_period
        ][0]
        ...
        def update_line_chart(
            ...
            try:
                fig1 = px.line(
                    ...
                    y=metric_list_proc,
                    labels={global_vars.timestamps: f"{global_vars.timestamps}(s)"},
                ).update_layout(
                ...
                try:
                    ...
                    try:
                        ...
                        fig3 = px.line(
                            ...
                            y=metric_list_p_proc,
                            labels={
                                global_vars.timestamps: f"{global_vars.timestamps}(s)"
                            },
                        ).update_layout(
                            title=title_tag_p_proc,
                            hovermode="x",
