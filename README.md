...
Workload Insight Tool (syswit) is a comprehensive tool to analyze workloads on Linux. 
...
$ syswit collect -w "./graph500.sh" -s 1 -n 25
    ...
    Directory Created: /path/to/workload-insight-tool/logs/2024_10_24_08_36_23_217897
    Command: ./graph500.sh > /path/to/workload-insight-tool/logs/2024_10_24_08_36_23_217897/workload.output
    Parent PID: 2737014
    Delay Time: 0
    Sample Period: 1.0
    nr_samples: 25
    ...
    * * * * * * * * * * * * * * * * * * * * * * * * * Saving logs...
    ...
    Killed Process 2737014

    Aggregating Start
    Results at: /path/to/workload-insight-tool/logs/2024_10_24_08_36_23_217897/results.json
    Workload Output at: /path/to/workload-insight-tool/logs/2024_10_24_08_36_23_217897/workload.output
```
...
Contact: Ayush Jain \<ayush.jain3@amd.com\>
